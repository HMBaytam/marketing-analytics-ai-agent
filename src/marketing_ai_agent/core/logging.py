...
class PerformanceLogger:
    ...
    def __enter__(self):
        ...
        self.logger.log(self.level, f"Starting {self.operation}", extra={
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        if exc_type:
            self.logger.error(f"Failed {self.operation} after {duration:.2f}s", extra={
                "operation": self.operation,
                "event": "failed",
                "duration": duration,
            ...
            self.logger.log(self.level, f"Completed {self.operation} in {duration:.2f}s", extra={
                "operation": self.operation,
                "event": "completed",
                "duration": duration
            })
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                logger.error(f"Marketing AI Agent error in {func.__name__}: {e.message}", extra={
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                logger.log(level, f"Failed {func.__name__}: {str(e)}", extra={
                    "function": func.__name__,
                    "success": False,
                    "error_type": type(e).__name__
                })
...
class AuditLogger:
    ...
    def log_api_call(self, api_name: str, endpoint: str, method: str, status_code: int, duration: float):
    ...
    def log_data_export(self, source: str, records_count: int, file_path: str, user: str = None):
        """Log data export operations."""
        self.logger.info("Data export completed", extra={
    ...
    def log_model_training(self, model_name: str, model_type: str, training_duration: float, accuracy: float = None):
    ...
    def log_optimization_run(self, optimization_type: str, campaigns_affected: int, estimated_impact: Dict[str, Any]):
        """Log optimization operations."""
        self.logger.info("Optimization run completed", extra={
    ...
    def log_report_generation(self, template_name: str, output_format: str, file_path: str, generation_time: float):
        """Log report generation."""
        self.logger.info("Report generated", extra={
