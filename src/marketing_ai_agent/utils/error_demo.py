...
from ..core.logging import get_logger, log_performance, PerformanceLogger, AuditLogger
from ..core.exceptions import (
    APIError, DataValidationError, OptimizationError, 
    RateLimitError, TemporaryServiceError
)
from ..core.error_handlers import (
    retry_on_error, circuit_breaker, handle_errors, RetryConfig, error_reporter
)
...
class DemoService:
    ...
    def data_validation_demo(self, data: dict) -> bool:
        ...
        self.logger.info("Data validation successful", extra={
            "record_id": data["id"],
...
def run_error_demo():
    ...
    logger.info("Error handling demonstration completed", extra={
