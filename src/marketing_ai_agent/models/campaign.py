...
class Campaign(BaseModel):
    ...
    impressions: int | None = Field(None, description="Total impressions")
    clicks: int | None = Field(None, description="Total clicks")
    conversions: float | None = Field(None, description="Total conversions")
    cost_micros: int | None = Field(None, description="Total cost in micros")

    # Computed fields
    ctr: float | None = Field(None, description="Click-through rate")
    average_cpc_micros: int | None = Field(
        None, description="Average cost per click in micros"
    )
    cost_per_conversion_micros: int | None = Field(
        None, description="Cost per conversion in micros"
    )
    conversion_rate: float | None = Field(None, description="Conversion rate")

    @property
    def budget_amount(self) -> Decimal | None:
    ...
    @property
    def average_cpc(self) -> Decimal | None:
...
class AdGroup(BaseModel):
    ...
    # Bidding
    cpc_bid_micros: int | None = Field(None, description="CPC bid in micros")
    cpm_bid_micros: int | None = Field(None, description="CPM bid in micros")
    target_cpa_micros: int | None = Field(None, description="Target CPA in micros")
...
class Keyword(BaseModel):
    ...
    cpc_bid_micros: int | None = Field(None, description="CPC bid in micros")
    first_page_cpc_micros: int | None = Field(
        None, description="First page CPC estimate"
    )
    top_of_page_cpc_micros: int | None = Field(
        None, description="Top of page CPC estimate"
    )
    ...
    average_position: float | None = Field(None, description="Average position")
    search_impression_share: float | None = Field(
        None, description="Search impression share"
    )
    search_exact_match_impression_share: float | None = Field(
        None, description="Exact match impression share"
    )
