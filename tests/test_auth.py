...
from marketing_ai_agent.auth.oauth2_manager import OAuth2Manager, OAuth2Config, TokenInfo
...
class TestOAuth2Manager:
    ...
    def test_credential_storage(self, mock_get_password, mock_set_password, oauth_config):
...
class TestGoogleAdsClient:
    ...
    def test_rate_limiting(self, mock_google_ads_client, mock_config):
        ...
        client = GoogleAdsAPIClient(config=mock_config, rate_limit_requests_per_minute=2)
...
def test_import_structure():
    ...
    from marketing_ai_agent.auth import OAuth2Manager, ConfigManager
