...
from marketing_ai_agent.core.exceptions import (
    MarketingAIAgentError, ConfigurationError, APIError, 
    DataValidationError, RateLimitError
)
from marketing_ai_agent.core.logging import (
    get_logger, initialize_logging, PerformanceLogger, AuditLogger
)
...
from marketing_ai_agent.core.monitoring import (
    HealthCheck, PerformanceMetrics, MetricsCollector, 
...
class TestConfig:
    ...
    def test_save_config_to_file(self, test_config, temp_dir):
        ...
        assert loaded_config.api.google_ads.client_id == test_config.api.google_ads.client_id
...
class TestErrorHandlers:
    ...
    def test_error_reporter(self):
        ...
        error_reporter.report_error(
            DataValidationError("Test validation error"),
            severity="WARNING"
        )
        ...
        assert "ValueError" in summary["error_counts"] or "DataValidationError" in summary["error_counts"]
...
class TestMonitoring:
    ...
    def test_system_monitor(self):
        ...
        assert not monitor._monitoring_active or True  # Might already be stopped in tests
...
class TestCoreIntegration:
    ...
    def test_monitoring_with_error_reporting(self):
        ...
        error_reporter.report_error(
            Exception("Test monitoring error"),
            context={"source": "monitoring_test"}
        )
    ...
    def test_config_validation_with_error_handling(self):
        ...
        def load_invalid_config():
            ...
            raise ConfigurationError("Invalid API key", config_key="api.google_ads.client_id")
        ...
        summary = error_reporter.get_error_summary()
        assert any("ConfigurationError" in error_type for error_type in summary["error_counts"].keys())
